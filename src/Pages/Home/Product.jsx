const Product = () => {
  const data = [
    ...
    },
    {
      ...
      description:
        "A wide range of Heavy Duty Corrugated Boxes can be manufacturing from us, which are known for their durability and perfect finishing. This box is best suitable for packaging of products like fruits, clothes, liquor bottles, stationery items, electronics and other allied materials. Further, this Heavy Duty Corrugated Box is made available with us in variety of shapes and sizes at negotiable prices.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      description:
        "We are one of the prominent manufacturer and supplier of Corrugated Carton Boxes. Our packaging products are manufactured using high grade raw materials that are obtained from some top ranked vendors. We offer a wide range of quality Components of Corrugated Boxes and Sheets that are available in various shapes, sizes and models as per the customer’s provided conditions.",
    },
    {
      id: 7,
  ...
  return (
    <div id="products" className="max-w-screen-xl mx-auto px-4 mt-16">
      <div className="p-2 border-2 border-r-gray-400 rounded mt-8">
        <h1 className="text-2xl font-semibold mt-4">Our Products</h1>
        {/* Card  */}
          ...
          {data.map((item) => (
            <div className="relative" key={item.id}>
              ...
              <div className="bg-[#000000b3] rounded-md  overflow-hidden w-full h-16 duration-500 hover:h-full absolute bottom-0">
                ...
                <p className="text-white mt-8 px-3 p-5">
                  {item.description}....
                </p>
              </div>
            </div>
