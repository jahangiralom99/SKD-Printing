    ...
    <div id="factory" className="max-w-screen-xl mx-auto px-4 mt-16">
      ...
      <div className="text-center mt-8">
        ...
        {open && (
          <div className="max-w-screen-xl mx-auto px-4">
            <div className="text-center mt-8">
              ...
              <p className="mt-4">
                We have integrated advanced and modern hardware in our factory
                to provide our clients with the enhanced quality of our
                products. The list of our modern machinery is listed below:
              </p>
            </div>
            <div className="text-center mt-12">
              <p>
                <span className="font-semibold">Name of Machine:</span> High
                Speed Corrugation Machine with variable control.
              </p>
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Brand :</span> Lal Engineering.
            ...
            <div className="text-center mt-12">
              ...
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Capacity : </span>6 Metric
                ton.(Both)
              </p>
              <hr className="mt-4 border" />
              <p className="mt-3">
            ...
            <div className="text-center mt-12">
              ...
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Brand :</span>(i) Lal
                Engineering & (ii) Selim Engineering.
              </p>
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Origin :</span> Bangladesh.
              ...
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Capacity : </span>(i) 15 Metric
                ton & (ii) 10 Metric ton.
              </p>
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Model :</span>2008
            ...
            <div className="text-center mt-12">
              ...
              <hr className="mt-4 border" />
              <p className="mt-3">
                <span className="font-semibold">Capacity : </span>20,000
                impression.
              </p>
              <hr className="mt-4 border" />
              <p className="mt-3">
        ...
        <div
          ...
          className={`mt-6 ${open == true ? "hidden" : ""}`}
        >
          <button className="px-5 py-2 border rounded">Learn More</button>
        </div>
        <div
          onClick={() => setOpen(false)}
          className={`mt-6 ${open == false ? "hidden" : ""}`}
        >
